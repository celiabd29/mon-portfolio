  ...
  return (
    <div className="bg-black text-white flex flex-col items-center justify-center px-4 bottom-30">
      ...
      <p className="font-raleway text-white text-center mt-10 mb-10 mx-4">
        À l'écoute d'opportunités en développement web, freelance ou alternance.
        Contactez-moi !
      </p>
      <form
        onSubmit={handleSubmit}
        className="w-full max-w-2xl md:w-1/2 bg-black md:mb-8 border-2 rounded-[30px] p-6 md:p-[2rem]"
      >
        <label className="text-white font-raleway mt-4 ml-4 text-lg">Nom</label>
        ...
        {response && <p className="text-white mt-2 text-center">{response}</p>}
      </form>
    </div>
  );
}
...
// <form
//   onSubmit={handleSubmit}
//   className="w-full max-w-md bg-black border-2 rounded-[30px] p-5 md:p-[3rem] z-10"
// >
//   {/* Nom */}
//   <label className="text-white font-raleway ml-3 text-sm md:text-lg">Nom</label>
//   <div className="relative">
//     <input
//       type="text"
//       name="name"
//       value={formData.name}
//       onChange={handleChange}
//       className="w-full mb-5 mt-1 px-5 py-3 pr-12 border border-white rounded-full bg-transparent text-white placeholder-gray-400 focus:outline-none"
...
//   {/* Email */}
//   <label className="text-white font-raleway ml-3 text-sm md:text-lg">
//     Email
//   </label>
//   <div className="relative">
//     <input
...
//       value={formData.message}
//       onChange={handleChange}
//       className="w-full mb-6 mt-1 px-5 py-3 pr-12 border border-white rounded-[40px] bg-transparent text-white placeholder-gray-400 focus:outline-none h-28 resize-none"
...
//   <button
//     type="submit"
//     className="w-full py-3 bg-violet-400 text-black font-medium rounded-full hover:bg-violet-300 transition"
//   >
//     Envoyer
//   </button>
