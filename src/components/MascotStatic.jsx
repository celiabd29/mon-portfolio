...
// Version statique (SVG) du perso, utilisee en secours si la 3D ne peut pas
// tourner. Meme identite clay bleu-gris + accent corail.
export default function MascotStatic({ className = "" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 320 340"
    ...
    >
      <defs>
        ...
        <radialGradient id="ms-cheek" cx="0.5" cy="0.5" r="0.5">
      ...
      <rect x="34" y="176" width="34" height="86" rx="17" fill="url(#ms-body)" />
      <rect x="252" y="176" width="34" height="86" rx="17" fill="url(#ms-body)" />
      <rect x="58" y="70" width="204" height="210" rx="52" fill="url(#ms-body)" />
      <rect x="88" y="104" width="144" height="118" rx="34" fill="url(#ms-screen)" />
      ...
      <circle cx="112" cy="196" r="16" fill="url(#ms-cheek)" />
      <circle cx="208" cy="196" r="16" fill="url(#ms-cheek)" />
